...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\Security\\ApiKeyAuthenticator')] fn () => ($container->privates['App\\Security\\ApiKeyAuthenticator'] ??= new \App\Security\ApiKeyAuthenticator($container->getEnv('API_KEY'))), 'onKernelRequest'], 10);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\CardController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
